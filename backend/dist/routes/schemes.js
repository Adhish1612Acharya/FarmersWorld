...
router.get("/", middlewares_1.getRequestLoginMiddleware, (0, wrapAsync_1.default)(schemes_1.default.allSchemes));
router.get("/:id", middlewares_1.getRequestLoginMiddleware, (0, wrapAsync_1.default)(schemes_1.default.singleScheme));
